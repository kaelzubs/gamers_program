"""
Django settings for web_aff project.
...
SECRET_KEY = '5krp5uw0_5j#t0b#bg8kxre3qx%&l#pjn1j0(_w-qik7!f3obq'
...
if DEBUG is True:
    ALLOWED_HOSTS = ['127.0.0.1', 'kaelzubs.pythonanywhere.com']
...
WSGI_APPLICATION = 'web_aff.wsgi.application'
